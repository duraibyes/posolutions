...
const ContactCard = () => {
    ...
    mt-10">
                <div className="flex flex-col items-start justify-center bg-[#F9FAFB] p-6 rounded-lg gap-2 hover:shadow-md" >
                    ...
                    <p className="text-[#0C7489]">+1 678-715-1430</p>
                </div>
                <div className="flex flex-col items-start justify-center bg-[#F9FAFB] p-6 rounded-lg gap-2 hover:shadow-md" >
                    ...
                    <p className="text-[#0C7489]">shan@posolutions.net</p>
                </div>
                <div className="flex flex-col items-start justify-center bg-[#F9FAFB] p-6 rounded-lg gap-2 hover:shadow-md " >
                    ...
                    <p className="text-[#0C7489]">6713 Church Street, Douglasville, GA 30134</p>
                </div>
